...
That shipped on all thirteen chapters of the encodings library until
2026-09-07 -- its published `11_Tools` page offered *awk* as the page after
it while the sidebar beside it
